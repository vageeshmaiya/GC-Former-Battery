...
from models import Informer, Autoformer, Transformer, DLinear, Linear, NLinear, GCformer
...
class Exp_Main(Exp_Basic):
    ...
    def _build_model(self):
        model_dict = {'GCformer': GCformer, 'Autoformer': Autoformer, 'Informer': Informer}
    ...
    def test(self, setting, test=0):
        ...
        f = open("result.txt", 'a')
        f.write(setting + "  \n")
        f.write('mse:{}, mae:{}, rse:{}, global_bias:{},local_bias:{}'.format(mse, mae, rse, float(global_bias), float(local_bias)))
        f.write('\n')
        f.write('\n')
        f.close()
