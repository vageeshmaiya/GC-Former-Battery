...
# data loader
parser.add_argument('--data', type=str, required=True, default='Battery', help='dataset type')
...
parser.add_argument('--enc_raw', type=int, default=3, help='encoder input size')
...
parser.add_argument('--e_layers', type=int, default=3, help='num of patchTST layers')
